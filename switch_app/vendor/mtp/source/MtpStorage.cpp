 ...
 * Modified 2026 by Transferencia Switch contributors: storage is advertised as
 * configurable access capability for read-only and controlled inbox storages.
 *
...
MtpStorage::MtpStorage(MtpStorageID id, const char* filePath,
        ...
        bool removable, uint64_t maxFileSize, bool writable)
    :   mStorageID(id),
        mFilePath(filePath),
...
int MtpStorage::getAccessCapability() const {
    return mWritable ? MTP_STORAGE_READ_WRITE : MTP_STORAGE_READ_ONLY_WITHOUT_DELETE;
}
