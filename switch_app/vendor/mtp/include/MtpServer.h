...
private:
    ...
    MtpString           mSendObjectTempPath;
    size_t              mSendObjectFileSize;
    bool                mWriteEnabled;
    transfer_switch::TransferObserver* mTransferObserver;
    transfer_switch::IncomingObjectSinkFactory* mSinkFactory;
    std::unique_ptr<transfer_switch::IncomingObjectSink> mSendObjectSink;
    bool                mSendObjectSinkCompleted;
    MtpStorageID        mSendObjectStorageID;
...
public:
                        MtpServer(USBMtpInterface* usb, MtpDatabase* database, bool ptp,
                                    int fileGroup, int filePerm, int directoryPerm,
                                    bool writeEnabled = false,
                                    transfer_switch::TransferObserver* observer = nullptr,
                                    transfer_switch::IncomingObjectSinkFactory* sinkFactory = nullptr);
    virtual             ~MtpServer();
